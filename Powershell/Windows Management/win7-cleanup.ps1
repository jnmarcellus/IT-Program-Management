#+------------------------------------------------------------+
# | Module Name:        Windows 7 Cleaup                       |
# | Module Purpose:     Cleanup Windows 7 Enviroment           |
...
### Disable last Logon
Set-RegistryKey -Path "HKLM:\Software\Microsoft\Windows\CurrentVersion\Policies\System" -Named "DontDisplayLastName" -Value 1
