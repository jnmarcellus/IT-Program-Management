#+------------------------------------------------------------+
# | Module Name:        Windows 10 Unpin                       |
# | Module Purpose:     Remove all Windows 10 Start Menu Pins  |
# | Module Modifier:    John Marcellus                         |
# | Module Date:        4/03/2018                              |
# +------------------------------------------------------------
# Reference: https://www.tenforums.com/customization/21002-how-automatically-cmd-powershell-script-unpin-all-apps-start.html
